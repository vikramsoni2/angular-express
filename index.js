...
var db = require('promised-mongo')(process.env.MONGODB || config.mongoDbName);

var routes = require('./server/routes/index');
var controllers = require('./server/controllers/index');
...
//Inject Database on every req object
